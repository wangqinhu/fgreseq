...
rect(max(gof)+1.2,3-0.5,125.8,15-0.5,col="#FFFFCC", border = "white")
rect(max(gof)+1.2,15-0.5,125.8,19-0.5,col="#FFCCCC", border = "white")
...
text(122,8.5,"MF",cex=0.6)
text(122,16.5,"BP",cex=0.6)
box()
